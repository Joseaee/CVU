    ...
    <section class="content__dashboard">
        <section class="top__section row">
            <div class="breadcrumb col-lg-10 col-md-8 col-sm-10 col-10">
                <h1><i class='bx bxs-cog'></i> Gestionar PNF</h1>
                <nav class="nav__breakcrumb">
                    <ul class="ul__breakcrumb">
                        ...
                        /
                        <li class="li__breakcrumb">
                            <a href="?url=pnf" class="link__breakcrumb"><i class='bx bxs-book-content'></i> Gestionar PNF</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><i class="bx bxs-book-content"></i> Agregar PNF</h5>
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" placeholder="Nombre PNF">
                </div>
