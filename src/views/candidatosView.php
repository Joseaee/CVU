    ...
    <section class="content__dashboard">
        <section class="top__section row">
            <div class="breadcrumb col-lg-10 col-md-8 col-sm-10 col-10">
                <h1><i class='bx bxs-cog'></i> Gestionar Candidatos</h1>
                <nav class="nav__breakcrumb">
                    <ul class="ul__breakcrumb">
                        ...
                        /
                        <li class="li__breakcrumb">
                            <a href="?url=candidatos" class="link__breakcrumb"><i class='bx bxs-group'></i> Gestionar Candidatos</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><i class="bx bxs-group"></i> Agregar Candidato</h5>
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <select name="select">
                        <option value="value1">Seccion1</option>
                        <option value="value2">Seccion2</option>
                    </select>
                </div>
